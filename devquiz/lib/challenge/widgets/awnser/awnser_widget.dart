...
class AwnserWidget extends StatelessWidget {
  ...
  TextStyle get _selectedTexStyleRight => isRight ? AppTextStyles.bodyDarkGreen : AppTextStyles.bodyDarkRed;
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Expanded(
              child: Text(title,style: isSelected ? _selectedTexStyleRight : AppTextStyles.body,)),
            Container(
              width: 24,
              height: 24,
              decoration: BoxDecoration(
