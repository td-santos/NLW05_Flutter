...
class AwnserWidget extends StatelessWidget {
  ...
  TextStyle get _selectedTexStyleRight => awnser.isRight ? AppTextStyles.bodyDarkGreen : AppTextStyles.bodyDarkRed;
        ...
        child: GestureDetector(
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                Expanded(
                  child: Text(awnser.title,style: isSelected ? _selectedTexStyleRight : AppTextStyles.body,)),
                Container(
                  width: 24,
                  height: 24,
                  decoration: BoxDecoration(
